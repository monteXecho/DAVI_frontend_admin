...
export default function AutoGrowingTextarea({ onSubmit, loading, disabled = false }) {
  ...
  return (
    <div className="relative w-full flex flex-col gap-2">
      <div className="relative w-full flex items-center">
        <textarea
          ref={textareaRef}
          placeholder={disabled ? "Wachtwoord vereist..." : "Stel een vraag"}
          rows={1}
          value={input}
          ...
          disabled={disabled}
          className={`w-full border border-[#23BD92] rounded-lg px-4 pr-[50px] py-4 font-montserrat text-[16px] leading-6 text-[#1f1f1f] resize-none overflow-hidden focus:outline-none ${
