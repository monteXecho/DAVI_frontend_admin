        ...
        <div className="flex h-[60px] bg-[#F9FBFA] items-center justify-between px-2">
            <div className="flex w-2/3 gap-4">
                ...
                <div className="relative w-4/9 h-10">
                    <input placeholder="Zoek map..." className="w-full h-full bg-white border border-[#D9D9D9] focus:outline-none rounded-full pl-4 pr-10 font-montserrat font-normal text-base leading-6 text-[#1E1E1E]" />
