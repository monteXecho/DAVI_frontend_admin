...
const RolPZData = [
    { Naam: 'Anna Bijsterbosch', Email: 'info@annabijsterbosch.nl', greenIcon: true, redIcon: true },
    { Naam: 'Carsten Altena', Email: 'info@creeert.net', greenIcon: true, redIcon: true },
    { Naam: 'JP Meijer', Email: 'jeanphilippe.meijer@mijndavi.nl', greenIcon: true, redIcon: true },
    { Naam: 'Carsten Altena', Email: 'info@creeert.net', greenIcon: true, redIcon: true },
    { Naam: 'JP Meijer', Email: 'jeanphilippe.meijer@mijndavi.nl', greenIcon: true, redIcon: true },
    { Naam: 'Carsten Altena', Email: 'info@creeert.net', greenIcon: true, redIcon: true },
    { Naam: 'JP Meijer', Email: 'jeanphilippe.meijer@mijndavi.nl', greenIcon: true, redIcon: true },
  ...
  return (
    <div className="flex flex-col w-[777px]">
        <div className="mb-[29px] font-montserrat font-extrabold text-[18px] leading-[100%]">
            14 gebruikers met de rol PZ
        </div>

        <div className="flex h-[60px] bg-[#F9FBFA] items-center justify-between px-2">
             <button className="w-[149px] h-[50px] border-[2px] border-[#23BD92] rounded-[8px] font-bold text-[16px] leading-[100%] text-[#23BD92]">
                Bulk uploaden
            </button>
        ...
        <div className="flex h-[60px] bg-[#F9FBFA] items-center justify-between px-2">
            ...
            {/* Search */}
            <div className="relative w-[213px] h-10">
                <input placeholder="Zoek gebruiker..." className="w-full h-full bg-white border border-[#D9D9D9] rounded-full pl-4 pr-10" />
        ...
        <table className="w-full border-separate border-spacing-0">
            <thead className="bg-[#F9FBFA] border-b border-[#C5BEBE]">
                <tr className="h-[51px] flex items-center gap-[40px] px-2">
                    <th className="flex items-center gap-5 w-3/7">
                        <input type="checkbox" className="w-4 h-4" />                        
                        <span>Naam</span>
                    </th>
                    <th className="flex items-center gap-5 w-4/7">E-mail</th>
            ...
            <tbody>
                {RolPZData.map(({Naam, Email, greenIcon, redIcon}, i) => (
                    <tr key={i} className="h-[51px] border-b border-[#C5BEBE] flex items-center gap-[40px]">
                        ...
                        <td className="w-4/7 px-4">{Email}</td>
