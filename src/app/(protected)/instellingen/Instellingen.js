            ...
            <div className="flex flex-col gap-[17px]">
                {
                    InstellingenData.map(data => { 
                        return (
                            <div 
                                key={data} 
                                className="w-[320px] h-[50px] bg-[#23BD92] rounded-lg flex flex-row justify-center items-center gap-2.5 px-[13px] py-[15px] font-montserrat font-bold text-[16px] leading-5 text-white text-center cursor-pointer"
                            >
                                {data}
                            </div>
                        )}
